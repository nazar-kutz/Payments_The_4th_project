...
<table class="header_tab">
    <tr>
        <td align="center">
            <a href="${pathManager.getUserCabinetUri()}" class="menu_point"><jtext:out value="link.go.to.cabinet"/></a>
        </td>
        <td align="center">
            <a href="${pathManager.getAdminCabinetUri()}" class="menu_point">ADMIN</a>
        </td>
        <td align="center">
            <a href="${pathManager.getUserCardReviewUri()}" class="menu_point"><jtext:out value="link.go.to.my.cards"/></a>
        </td>
        <td align="center">
